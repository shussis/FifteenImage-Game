     ...
     1 Разархировать zip-архив, содержащий файлы  проека «FifteenImage».
     2 Скопировать текст скрипта fifteen1 из архива и вставить его в окно создания запроса СУБД  PostgreSQL. 
     3 Запустить exe-файл FifteenImage. Теперь можно приступать к самой игре!
